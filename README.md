...
|-------|------------------|
| ![Input screenshot](docs/screenshots/input-screenshot.png) | ![Results screenshot](docs/screenshots/output-screenshot.png) |
...
Willouby — Final-year BSc IT (Software Engineering) student, Eduvos Cape Town
Built during a Backend AI Engineering internship at FlyRank AI
